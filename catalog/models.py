...
class Book(models.Model):
    ...
    """ Foreign Key used because book can only have one author,
        but authors can have multiple books Author as a string
        rather than object because it hasn't been declared yet in the file
    """
    ...
    isbn = models.CharField(
        'ISBN',
        max_length=13,
        help_text='13 <a href="https://www.isbn-international.org">ISBN</a>'
    )
